...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <div>
                <h4 class="mb-0 fw-bold">Create Collection</h4>
                <small class="text-muted">Add new deposit collection</small>
            </div>
        ...
        <div class="card border-0 shadow-sm rounded-3">
            <div class="card-body">
                ...
                <form action="{{ route('deposit-collections.store') }}" method="POST">
                    @csrf
